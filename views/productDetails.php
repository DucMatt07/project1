...
<body>
    <div class="container text-[#4a4a4a]" id="showHere">
        ...
        <div class="main w-screen">
            ...
            <section class=" w-[1200px]  my-[0] mx-[auto] py-[10px]">
                <div class="header-section flex gap-[10px] items-center ">
                    <h1 class="product-name line-clamp-3 text-[#0a263c] text-[18px] font-bold"> Samsung Galaxy S24 Ultra
                        12GB
                        256GB </h1>
                ...
                <div class="body-section flex justify-between  ">
                            ...
                            <div class="temp-price-product">
                                <div class="price flex">
                                    ...
                                    <div class="price-number text-[#d02c35] font-semibold ml-[5px] ">
                                        <?= $product['product_new_price'] ?> đ</div>
                                </div>
                    ...
                    <div class="section-right w-[40%] box-border">
                        ...
                        <div class="right-price w-full bg-[#eeeeef] rounded-[5px] mb-[10px] min-h-[65px] flex p-[5px]">
                            <div class="col-6 w-[50%] flex items-center justify-center p-[5px]">
                                <div class="icon-trade h-[33px] w-[35px]">
                                    <img class="w-full h-full object-cover" src="./img/pdp-trade-icon.png" alt="">
                                </div>
                        ...
                        <div class=" mt-[10px] right-banner w-full mr-[10px] rounded-[5px]">
                            <img class="w-full rounded-[5px]" src="./img/banner-product.webp" alt="">
                        </div>
                        ...
                        <div class=" box-more-sale mt-[0.75rem] mb-[0.75rem] w-full border-[1px] border-solid border-[#d1d5db] rounded-[10px] overflow-hidden">
                            ...
                            <div class="sale-container">
                                <ul>
                                    ...
                                    <li class="text-[12px] my-[10px] mx-[5px] flex items-center gap-[3px] ">
                                        <img class="mr-[4px]" src="./img/check-product.svg" alt="">
                                        <img class="h-[16px] object-cover" src="./img/vib_product_sale.webp" alt="">
                                        <a class="text-[#000]" href="#">Giảm đến 600K khi mở thẻ tín dụng VIB</a>
                                    </li>
                                    <li class="text-[12px] my-[10px] mx-[5px] flex items-center gap-[3px] ">
                                        <img class="mr-[4px]" src="./img/check-product.svg" alt="">
                                        <img class="h-[16px] object-cover" src="./img/ocb_product_sale.webp" alt="">
                                        <a class="text-[#000]" href="#">Giảm 500K khi thanh toán qua thẻ OCB</a>
                                    </li>
                                    <li class="text-[12px] my-[10px] mx-[5px] flex items-center gap-[3px] ">
                                        <img class="mr-[4px]" src="./img/check-product.svg" alt="">
                                        <img class="h-[16px] object-cover" src="./img/zv0_product_sale.webp" alt="">
