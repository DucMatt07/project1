        ...
        <div
            ...
            <div class="  p-6 space-y-4 md:space-y-6 sm:p-8 relative">
                ...
                <form id="formLogin" class="space-y-4 md:space-y-6" method="POST" action="?action=login">
                    ...
                    <p class="text-sm flex justify-between font-light text-gray-500 dark:text-gray-400">
                        <span>Chưa có tài khoản? <a href="#" id="openSignIn"
                                class=" font-medium  text-[blue] hover:underline dark:text-primary-500">Đăng kí
                                ngay</a></span>
                        <a href="#" id="openForgotPass"
                            class="font-medium  text-[blue] hover:underline dark:text-primary-500">Quên mật
                            khẩu</a>
                    </p>
                </form>
            </div>
