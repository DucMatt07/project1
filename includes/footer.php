        ...
        <div class="footer-top-container box-border my-0 mx-auto w-[1200px] flex justify-between gap-[10px]">
                        ...
                        <ul class="list-pays">
                            <li
                                ...
                                <a href="#" class="w-full h-full">
                                    <img src="./img/apple-pay-og.webp" alt="" />
                                </a>
                            </li>
                            <li
                                class="pay inline-block text-[12px] mb-[5px] rounded-[3px] border-[1px] border-solid border-[#dee2e6] h-[32px] w-[50px] align-middle">
                                <a href="#" class="w-full h-full">
                                    <img src="./img/vnpay-logo.webp" alt="" />
                                </a>
                            </li>
                            <li
                                class="pay inline-block text-[12px] mb-[5px] rounded-[3px] border-[1px] border-solid border-[#dee2e6] h-[32px] w-[50px] align-middle">
                                <a href="#" class="w-full h-full">
                                    <img src="./img/momo_1.webp" alt="" />
                                </a>
                            </li>
                            <li
                                class="pay inline-block text-[12px] mb-[5px] rounded-[3px] border-[1px] border-solid border-[#dee2e6] h-[32px] w-[50px] align-middle">
                                <a href="#" class="w-full h-full">
                                    <img src="./img/onepay-logo.webp" alt="" />
                                </a>
                            </li>
                            <li
                                class="pay inline-block text-[12px] mb-[5px] rounded-[3px] border-[1px] border-solid border-[#dee2e6] h-[32px] w-[50px] align-middle">
                                <a href="#" class="w-full h-full">
                                    <img src="./img/mpos-logo.webp" alt="" />
                                </a>
                            </li>
                            <li
                                class="pay inline-block text-[12px] mb-[5px] rounded-[3px] border-[1px] border-solid border-[#dee2e6] h-[32px] w-[50px] align-middle">
                                <a href="#" class="w-full h-full">
                                    <img src="./img/kredivo-logo.webp" alt="" />
                                </a>
                            </li>
                            <li
                                class="pay inline-block text-[12px] mb-[5px] rounded-[3px] border-[1px] border-solid border-[#dee2e6] h-[32px] w-[50px] align-middle">
                                <a href="#" class="w-full h-full">
                                    <img src="./img/zalopay-logo.webp" alt="" />
                                </a>
                            </li>
                            <li
                                class="pay inline-block text-[12px] mb-[5px] rounded-[3px] border-[1px] border-solid border-[#dee2e6] h-[32px] w-[50px] align-middle">
                                <a href="#" class="w-full h-full">
                                    <img src="./img/alepay-logo.webp" alt="" />
                                </a>
                            </li>
                            <li
                                class="pay inline-block text-[12px] mb-[5px] rounded-[3px] border-[1px] border-solid border-[#dee2e6] h-[32px] w-[50px] align-middle">
                                <a href="#" class="w-full h-full">
                                    <img src="./img/fundiin.webp" alt="" />
                                </a>
                            </li>
                        </ul>
                    </div>
                            ...
                            <div class="download-app">
                                <p class="flex gap-[5px] items-center text-nowrap">
                                    <svg width="15" height="15" viewBox="0 0 38 38" fill="none"
                                        ...
                                        <defs>
                                            <pattern id="pattern0_1350_26900" patternContentUnits="objectBoundingBox"
                                                width="1" height="1">
                                                <use xlink:href="#image0_1350_26900" transform="scale(0.00444444)">
                                                </use>
                                            </pattern>
                                ...
                                <div class="qr-app flex mt-[5px]">
                                    <img src="./img/QR_appGeneral.webp" class="w-[40%] h-[40%] object-cover" alt="" />
                                    <div class="flex flex-wrap w-[55%]">
                                        <a href="#" class="p-[3px]">
                                            <img src="./img/downloadANDROID.webp" class="w-full h-[auto]" alt="" /></a>
                                        <a href="#" class="p-[3px]">
                                            <img src="./img/downloadiOS.webp" class="w-full h-[auto]" alt="" /></a>
                                    </div>
                                </div>
                            </div>
                        </li>
            ...
            <div class="footer-connect">
                ...
                <div class="icons-social flex gap-[5px]">
                    <a href="#"><img src="./img/cellphones-youtube.webp" class="p-[5px]" alt="" /></a>
                    <a href="#"><img src="./img/cellphones-facebook.webp" class="p-[5px]" alt="" /></a>
                    <a href="#"><img src="./img/cellphones-instagram.webp" class="p-[5px]" alt="" /></a>
                    <a href="#"><img src="./img/cellphones-tiktok.webp" class="p-[5px]" alt="" /></a>
                    <a href="#"><img src="./img/cellphones-zalo.webp" class="p-[5px]" alt="" /></a>
                </div>
                <p class="title text-[16px] font-medium text-[#363636]">
                    Website thành viên
                </p>
                <div class="website-member mt-[5px]">
                    ...
                    <a href="#"><img src="./img/dienthoaivui.webp" alt="" /></a>
                    <p class="text-[#3f3f3f] text-[12px] font-normal mb-[5px]">
                        Trung tâm bảo hành uỷ quyền Apple
                    </p>
                    <a href="#"><img src="./img/Logo_CareS_1.webp" alt="" /></a>
                    <p class="text-[#3f3f3f] text-[12px] font-normal mb-[5px]">
                        Kênh thông tin giải trí công nghệ cho giới trẻ
                    </p>
                    <a href="#"><img src="./img/schanel.webp" alt="" /></a>
                    <p class="text-[#3f3f3f] text-[12px] font-normal mb-[5px]">
                        Trang thông tin công nghệ mới nhất
                    </p>
                    <a href="#"><img src="./img/sforum.webp" alt="" /></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="footer-bottom-container w-[1200px] my-[0] mx-[auto] box-border">
            ...
            <div class="bottom-infor">
                ...
                <div class="bottom-infor-img flex items-center justify-center gap-[3px]">
                    <a href="#"><img src="./img/footer-info-1.webp" alt="" /></a>
                    <a href="#"><img class="h-[20px]" src="./img/footer-info-2.png" alt="" /></a>
                </div>
            </div>
        </div>
    </div>
